...
def run_policy(env, policy, scaler, logger, episodes, animate, episode, max_iteration, save_x_episode_model):
    ...
    for e in range(episodes):
        observes, actions, rewards, unscaled_obs = run_episode(env, policy, scaler, animate, 1000)
...
def main(num_episodes, gamma, lam, kl_targ, batch_size, animate, model_folder, max_iteration, save_x_episode_model, seed, env_name='Hopper-v4'):
    global model_path
    """ Main training loop
