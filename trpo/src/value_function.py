...
class NNValueFunction(object):
    ...
    def __init__(self, obs_dim, model_path, save_x_episode_model, load_prev=False):
        """
        Args:
        ...
        if(load_prev):
            value_func_file = open(self.model_path + "/info/value_function.pkl", "rb")
            value_func_data = pickle.load(value_func_file)
            value_func_file.close()
            self.replay_buffer_x = value_func_data['replay_buffer_x']
            self.replay_buffer_y = value_func_data['replay_buffer_y']
        else:
